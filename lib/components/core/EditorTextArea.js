...
var EditorTextArea = function (_Component) {
	...
	_createClass(EditorTextArea, [{
		...
		value: function render() {
			return _react2.default.createElement('textarea', { ref: 'root', className: 'editor-textarea', value: this.state.content, onChange: this.handleChange.bind(this), onInput: this.props.onInput });
		}
	}]);
