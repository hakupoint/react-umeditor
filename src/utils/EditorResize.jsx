...
export default class EditorResize extends Component {
  ...
  setTarget(target) {
    ...
    var position = EditorDOM.getOffsetRootParentPosition(
      target,
      root.parentElement
    );
  ...
  render() {
    ...
    return (
      <div className="editor-resize-container" ref="root">
        <div className="editor-resize" style={style}>
          ...
          <div
            className="block-resize nw-resize"
          />
          <div
            className="block-resize ne-resize"
          />
          <div
            className="block-resize sw-resize"
          />
          <div
            className="block-resize se-resize"
          />
        </div>
      </div>
    );
